...
<header class="sticky top-0 z-40 border-b border-hairline bg-void/90 px-6 py-4 backdrop-blur-md md:px-10">
	<div class="mx-auto flex max-w-6xl items-center justify-between gap-4">
		...
		<div class="flex items-center gap-4">
			<span class="hidden font-mono text-[11px] text-ink-faint sm:inline">{name}</span>
			<UserMenu />
		</div>
	</div>
</header>
